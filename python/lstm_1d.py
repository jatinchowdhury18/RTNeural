...
plt.plot(y, '--')
plt.ylim(-0.5, 0.5)
plt.savefig('python/lstm_1d.png')

# save signals
np.savetxt('test_data/lstm_1d_x_python.csv', x, delimiter=',')
np.savetxt('test_data/lstm_1d_y_python.csv', y, delimiter=',')

save_model(model, 'models/lstm_1d.json')
